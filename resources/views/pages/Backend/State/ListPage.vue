    ...
    <MasterDataLayout #content>
        <q-page padding>
            <div class="flex justify-between items-center">
                <div>
                    <div class="my-title">List of States</div>
                    <div class="text-caption">List of state of India</div>
                </div>
            ...
            <div class="flex justify-between items-center q-my-md">
                ...
                <q-btn :href="route('state.create')" color="primary" label="New State" rounded/>
            </div>
                ...
                <q-list separator>
                    <q-item class="q-pa-none" v-for="(item,index) in listData.data"
                        ...
                        <q-item-section side>
                            ...
                            <q-item-label>{{item?.state_name}}</q-item-label>
                            <div class="flex flex-inline justify-center q-gutter-sm">
                                <q-btn :href="route('state.edit',item.id)" icon="edit" outline round size="12px"/>
...
const handleDelete = (item) => {
    q.dialog({
        ...
        Inertia.delete(route('state.destroy', item.id),{
